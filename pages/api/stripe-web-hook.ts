...
// потому что нам надо обновить статус заказа после оплаты
...
// все, что тут происходит, происхоит после завершения заказа
/**
 * Update Order.
 *
...
// обработчик, который проеверяет post ли это запрос и устанавливает заголовки для stripe
